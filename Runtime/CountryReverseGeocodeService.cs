...
namespace Wibci.CountryReverseGeocode
{
    ...
    public class CountryReverseGeocodeService : ICountryReverseGeocodeService
    {
        ...
        {
            CountryDataProvider = new DefaultCountryDataProvider();
            USAStateDataProvider = new DefaultUSAStateDataProvider();
        }
        public CountryReverseGeocodeService(IReverseGeocodeDataProvider countryDataProvider, IReverseGeocodeDataProvider statesDataProvider)
        {
            CountryDataProvider = countryDataProvider;
            USAStateDataProvider = statesDataProvider;
        }
